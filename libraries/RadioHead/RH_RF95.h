...
public:
	...
	Bw31_25Cr45Sf4096,           /// Super long range
	Bw7_8Cr45Sf4096,           /// Super long range
	Bw125Cr45Sf4096,           /// Test
	Bw41_7Cr45Sf4096,           /// Test
	Bw62_5Cr45Sf4096,           /// Test
	Bw31_25Cr45Sf1024,           /// Test
	Bw7_8Cr45Sf128,           /// Test
	Bw41_7Cr45Sf512,           /// Test
	Bw41_7Cr45Sf1024,           /// Test
	Bw62_5Cr45Sf2048,           /// Test
	Bw20_8Cr45Sf512,           /// Test
	Bw20_8Cr45Sf128,           /// Test
	Bw20_8Cr45Sf64,           /// Test
	Bw62_5Cr45Sf1024,           /// Test
	Bw31_25Cr45Sf512,           /// Test
	Bw125Cr45Sf2048,           /// Test
        Bw15_6Cr45Sf128, 
        Bw10_4Cr45Sf128,
        Bw7_8Cr45Sf512,
        Bw31_25Cr45Sf128
    ...
    /// of 0 is permitted. 
    /// CAD timeout set to default RH_DEFAULT_CAD_TIMEOUT = 10000
    /// \param[in] data Array of data to be sent
    /// \param[in] len Number of bytes of data to send
    /// \return true if the message length was valid and it was correctly queued for transmit
    virtual bool    send(const uint8_t* data, uint8_t len);

    /// Same as send, but with a user specified timeout for CAD timeout.
    virtual bool    send(const uint8_t* data, uint8_t len, unsigned long cad_timeout);
    ...
    /// Using the radio's CAD function to detect channel activity.
