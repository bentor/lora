...
public:
	...
	RHModeRx,                ///< Transport is in the process of receiving a message.
       RHModeCad                ///< Transport is in the process of detecti    ng channel activity.
    } RHMode;
    ...
    /// Blocks until channel activity is finished or timeout.
    /// Using the radio's CAD function to detect channel activity.
    /// Implements a listen-before-talk mechanism (Collision Avoidance).
    virtual bool            waitCad(unsigned long cad_timeout);
